...
import com.xtended.glyph.Settings.SettingsActivity;
...
public class TileActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (sourceClass.getClassName().equals("com.xtended.glyph.Tiles.GlyphTileService")
            || sourceClass.getClassName().equals("com.xtended.glyph.Tiles.TorchTileService")) {
